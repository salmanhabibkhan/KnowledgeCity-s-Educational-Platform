...
export declare function conflictsWithAutoMode(minExpectedVersion: string | null): (target: Object, key: string | symbol, descriptor: PropertyDescriptor) => PropertyDescriptor;
